...
const ProjectImageData = [
  ...
  const MathematicsData = [
    ...
    { url: "https://github.com/kleungkt/Linear-Algebra", text: ["Linear", "Algebra"] },
    ...
    { url: "https://github.com/kleungkt/Optimization", text: "Optimization" },
  ...
  const DataScienceTechStackData = [
    ...
    {
      url: "https://github.com/kleungkt/Excel-VBA-Programming",
...
const ComputerScienceKnowledge = [
    ...
    {
      url: "https://github.com/kleungkt/discrete-maths",
      text: ["Discrete", "Maths"]
    },
    {
    ...
    {
      url: "https://github.com/kleungkt/comp-architecture",
